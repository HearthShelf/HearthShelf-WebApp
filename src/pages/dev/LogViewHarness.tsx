...
const LOGS = [
  {
    timestamp: '2026-08-13 02:42:24.298',
    level: 2,
    source: 'LogManager.js:71',
    message: '[LogManager] Init current daily log filename: 2026-08-13.txt',
  },
  {
    timestamp: '2026-08-13 02:42:24.425',
    level: 2,
    source: 'BackupManager.js:327',
    message: '[BackupManager] 7 Backups Found',
  },
  {
    timestamp: '2026-08-13 02:42:24.440',
    level: 2,
    source: 'Watcher.js:58',
    message: '[Watcher] Initializing watcher for "Audiobooks".',
  },
  {
    timestamp: '2026-08-13 02:42:24.452',
    level: 2,
    source: 'Server.js:425',
    message: '[Server] Listening on port :13378',
  },
  {
    timestamp: '2026-08-13 02:46:30.188',
    level: 2,
    source: 'PlaybackSessionManager.js:317',
    message:
      '[PlaybackSessionManager] startSession: Closing open session "Accidental Champion 2" for user "wutname1" (Device: Windows 10 / Edge)',
  },
  {
    timestamp: '2026-08-13 02:47:08.273',
    level: 2,
    source: 'LibraryItemController.js:1135',
    message:
      '[LibraryItemController] User "wutname1" requested download for item "Hollow" ebook at "/audiobooks/Travis Bagwell/Hollow B0D68GCK6V/Hollow.epub"',
  },
  {
    timestamp: '2026-08-13 02:47:25.078',
    level: 4,
    source: 'LibraryItemController.js:1130',
    message: '[LibraryItemController] No ebookFile for library item "Accidental Champion 2"',
  },
  {
    timestamp: '2026-08-13 02:49:00.818',
    level: 2,
    source: 'Database.js:217',
    message: '[Database] Initializing db at "/config/absdatabase.sqlite"',
  },
  {
    timestamp: '2026-08-13 02:49:00.852',
    level: 2,
    source: 'Database.js:292',
    message: '[Database] Loading extension /usr/local/lib/nusqlite3/libnusqlite3.so',
  },
  // The pathological one: a very long unbroken-ish run that previously blew out the width.
  {
    timestamp: '2026-08-13 02:49:00.978',
    level: 2,
    source: 'Database.js:201',
    message:
  ...
  {
    timestamp: '2026-08-13 02:49:01.085',
    level: 3,
    source: 'Database.js:207',
    message: '[Database] running ANALYZE',
  },
  {
    timestamp: '2026-08-13 02:54:36.091',
    level: 1,
    source: 'Server.js:145',
    message: '[Server] Node.js Version: v24.18.1',
  },
  {
    timestamp: '2026-08-13 02:54:36.091',
    level: 0,
    source: 'Server.js:147',
    message: '[Server] Arch: x64',
  },
  {
    timestamp: '2026-08-13 02:55:10.004',
    level: 5,
    source: 'Server.js:900',
    message:
      '[Server] Unrecoverable: /a/very/long/unbroken/path/without/spaces/that/must/break/mid-token/or/it/will/force/the/grid/wider/than/the/modal/and/push/it/off/screen/entirely.log',
  },
]
